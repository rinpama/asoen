...
urlpatterns = [
    ...
    path('kyouryokumember', KyouryokuMember.as_view(), name='kyouryokumember'),
    path('generalcontractor', GeneralContractor.as_view(), name='generalcontractor'),
    ...
    path('loginkyouryokulist', LoginKyouryokuList, name='loginkyouryokulist'),
    path('logingeneralconstractorlist', LoginGeneralconstractorList, name='logingeneralconstractorlist'),
